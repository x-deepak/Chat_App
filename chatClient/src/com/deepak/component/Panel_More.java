...
import com.deepak.app.MessageType;
import com.deepak.emoji.Emogi;
import com.deepak.emoji.Model_Emoji;
import com.deepak.event.PublicEvent;
import com.deepak.main.Main;
import com.deepak.model.Model_Send_Message;
import com.deepak.model.Model_User_Account;
import com.deepak.service.Service;
import com.deepak.swing.ScrollBar;
import com.deepak.swing.WrapLayout;
...
//        panelHeader.add(getButtonFile());
    ...
    private JButton getButtonImage() {
        ...
        cmd.setIcon(new ImageIcon(getClass().getResource("/com/deepak/icon/image.png")));
    ...
    private JButton getButtonFile() {
        OptionButton cmd = new OptionButton();
        cmd.setIcon(new ImageIcon(getClass().getResource("/com/deepak/icon/link.png")));
        cmd.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent ae) {
                JFileChooser ch = new JFileChooser();
    ...
    private JButton getEmojiStyle3() {
        OptionButton cmd = new OptionButton();
        cmd.setIcon(Emogi.getInstance().getImoji(411).toSize(25, 25).getIcon());
        cmd.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent ae) {
                clearSelected();
