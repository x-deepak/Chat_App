...
public class Chat_Item extends javax.swing.JLayeredPane {
    ...
    public void sendSuccess() {
        if (label != null) {
            label.setIcon(new ImageIcon(getClass().getResource("/com/deepak/icon/tick.png")));
        }
    }

    public void seen() {
        if (label != null) {
            label.setIcon(new ImageIcon(getClass().getResource("/com/deepak/icon/double_tick.png")));
        }
    }
    ...
    private void initComponents() {
        ...
        txt = new com.deepak.swing.JIMSendTextPane();
    ...
    private com.deepak.swing.JIMSendTextPane txt;
