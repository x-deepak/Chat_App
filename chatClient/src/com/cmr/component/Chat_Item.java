...
public class Chat_Item extends javax.swing.JLayeredPane {
    ...
    public void setTime(String time) {
        ...
        label.setFont(label.getFont().deriveFont(Font.PLAIN, 10)); // Adjust font size
    ...
    public void sendSuccess() {
        if (label != null) {
            label.setIcon(new ImageIcon(getClass().getResource("/com/cmr/icon/tick.png")));
        }
    }

    public void seen() {
        if (label != null) {
            label.setIcon(new ImageIcon(getClass().getResource("/com/cmr/icon/double_tick.png")));
        }
    }
    ...
    private void initComponents() {
        ...
        txt = new com.cmr.swing.JIMSendTextPane();

        setLayout(new javax.swing.BoxLayout(this, javax.swing.BoxLayout.PAGE_AXIS));

        txt.setBorder(javax.swing.BorderFactory.createEmptyBorder(10, 10, 5, 10));
        txt.setFont(new java.awt.Font("MV Boli", 0, 16)); // NOI18N
        txt.setSelectionColor(new java.awt.Color(117, 191, 250));
        add(txt);
    ...
    private com.cmr.swing.JIMSendTextPane txt;
